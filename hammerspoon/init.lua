...
-- This config includes basic Vim binding remaps…
-- ⚙️ Give accessability permissions to Hammerspoon.
-- NOTE: Change "Key repeat rate"＆"Delay until repeat" in MacOS settings
-- restart Hammerspoon to pick up any config changes…
-- https://github.com/Hammerspoon/hammerspoon/issues/3264
